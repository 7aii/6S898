...
In this study, we have conducted two experiments providing empirical support for the learned-representation explanation of the grokking phenomenon. This explanation posits that grokking emerges from a transition of the model's internal structure from a memorizing circuit to a generalizing one. Our first experiment highlights the crucial role of weight decay in this transition, corroborating the assertions made by Verma et al. (2023)<d-cite key="varma2023explaining"></d-cite>. The second experiment further illuminates the dynamics of this transition by exploring the effects of varying the fraction of outliers in the training data.
